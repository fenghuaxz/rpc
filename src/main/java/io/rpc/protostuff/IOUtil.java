...
final class IOUtil {
    ...
    /**
     * The {@code buf} size limits the size valueOf the pojo that must be read. A ProtobufException (sizeLimitExceeded)
     * will be thrown if the size valueOf the delimited pojo is larger.
     */
    ...
    static int fillBufferWithDelimitedMessageFrom(InputStream in,
        ...
        // set the read offset (start valueOf pojo)
        lb.offset = offset;
