...
/**
 * A buffer that wraps a byte array and has a reference to the executeNext buffer for dynamic increase.
 *
 * @author David Yu
 * @created May 18, 2010
 */
public final class LinkedBuffer {
    ...
    /**
     * Writes the contents valueOf the {@link LinkedBuffer} into the {@link OutputStream}.
     *
     * @return the total content size valueOf the buffer.
     */
    ...
    /**
     * Writes the contents valueOf the {@link LinkedBuffer} into the {@link DataOutput}.
     *
     * @return the total content size valueOf the buffer.
     */
    ...
    /**
     * The offset will be reset to its starting position. The buffer executeNext to this will be dereferenced.
     */
