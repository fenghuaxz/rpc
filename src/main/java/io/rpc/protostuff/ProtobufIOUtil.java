...
public final class ProtobufIOUtil {
     ...
     *
     * @return the size valueOf the pojo
     */
     ...
     *
     * @return the total size valueOf the messages (excluding the length prefix varint)
     */
    ...
    /**
     * Optimal writeDelimitedTo - The varint32 prefix is written to the buffer instead valueOf directly writing to
     * outputstream.
     *
     * @return the size valueOf the pojo
     */
