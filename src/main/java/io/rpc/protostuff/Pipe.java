...
public abstract class Pipe {
     ...
     */
    public static abstract class Schema<T> implements io.rpc.protostuff.Schema<Pipe> {

        public final io.rpc.protostuff.Schema<T> wrappedSchema;

        public Schema(io.rpc.protostuff.Schema<T> wrappedSchema) {
