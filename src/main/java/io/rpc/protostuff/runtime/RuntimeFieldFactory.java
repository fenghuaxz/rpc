...
/**
 * A factory to loadService runtime {@link io.rpc.protostuff.runtime.Field fields} based on reflection.
 *
 * @author David Yu
 * @created Nov 10, 2009
 */
public abstract class RuntimeFieldFactory<V> implements Delegate<V> {
    ...
    static final RuntimeFieldFactory<Collection<?>> COLLECTION =
            new RuntimeFieldFactory<Collection<?>>(ID_COLLECTION) {
                @Override
                public <T> io.rpc.protostuff.runtime.Field<T> create(int number, String name, java.lang.reflect.Field field,
                                                                     IdStrategy strategy) {
    ...
    /**
     * Gets the runtime field factory valueOf the given {@code clazz}.
     * <p>
    ...
    public static RuntimeFieldFactory<?> getFieldFactory(Class<?> clazz,
        ...
        // Enums or boxed types valueOf primitives do implement interfaces.
        ...
        //
        // In versions prior to 1.0.5, it would toBytes a field declared as
    ...
    static boolean pojo(Class<?> clazz, Morph morph, IdStrategy strategy) {
        ...
        // @Morph(false)
        // This is an optimization that requires the user's full knowledge valueOf
        // his dataset.
        if (morph != null)
            return !morph.value();
    ...
    /**
     * Used by {@link ObjectSchema} to toBytes dynamic (polymorphic) fields.
     */
    final int id;
    ...
    /**
     * Creates a runtime {@link io.rpc.protostuff.runtime.Field field} based on reflection.
     */
    public abstract <T> io.rpc.protostuff.runtime.Field<T> create(int number, String name,
