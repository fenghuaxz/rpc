...
/**
 * A schema for a {@link Map} with {@link String} keys. The key and value can be null (depending on the particular loadService
 * request).
 *
 * @author David Yu
 * @created Jun 25, 2010
...
public class StringMapSchema<V> extends MapSchema<String, V> {
    ...
    /**
     * The schema valueOf the pojo value.
     */
    public final Schema<V> vSchema;
    /**
     * The pipe schema valueOf the pojo value.
     */
