...
/**
 * An Input lets an application read primitive data types and objects from a source valueOf data.
 *
 * @author David Yu
 * @created Nov 9, 2009
 */
public interface Input {
    ...
    /**
     * Reads the field number valueOf a pojo/object tied to the given {@link Schema schema}.
     */
    ...
    /**
     * Transfer the byte range to the output. Capable valueOf zero-copy transfer depending on the type valueOf input.
     */
